...
router.post("/", verifyToken, async (req, res) => {
  try {
    ...
    const result = await db.query(
      `INSERT INTO researchers (name, full_name, role, position, email, research_areas, expertise, orcid_id, ciencia_id, google_scholar, linkedin_url, bio, status_membership, image_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
